...
void StudioModel::SetUpBones ( void )
{
	...
	if (m_sequence >=  m_pstudiohdr->numseq | m_sequence < 0) {
		m_sequence = 0;
	}
...
void StudioModel::SetupLighting ( )
{
	...
	g_lightcolor[0] = 1.0f;//settings.lightcolor[0];
	g_lightcolor[1] = 1.0f;//settings.lightcolor[1];
	g_lightcolor[2] = 1.0f;//settings.lightcolor[2];
